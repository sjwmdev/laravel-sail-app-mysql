...
<head>
    ...
    @yield('css')
    @include('dashboard.layouts.partials._preload')
</head>
...
<body class="hold-transition sidebar-mini layout-footer-fixed layout-navbar-fixed">
    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light text-sm">
            @include(config('system.paths.dashboard.layouts_partials') . '_navbar')
        </nav>

        <div id="leftsidebar">
            @include(config('system.paths.dashboard.layouts_partials') . '_leftsidebar')
        </div>

        <div class="content-wrapper">
            <div class="content-header">
                <div class="container-fluid">
                    @include(config('system.paths.dashboard.layouts_partials') . '_breadcrumb')
                </div>
            </div>
        ...
        <aside class="control-sidebar control-sidebar-dark">
            @include(config('system.paths.dashboard.layouts_partials') . '_rightsidebar')
        </aside>

        <footer class="main-footer text-sm">
            @include(config('system.paths.dashboard.layouts_partials') . '_footer')
        </footer>
    ...
    @include(config('system.paths.dashboard.layouts_partials') . '_toastr_message')
