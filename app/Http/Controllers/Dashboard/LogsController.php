...
class LogsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view(config('system.paths.dashboard.base') . 'logs.index', compact('logs'));
    }
    ...
    public function filter()
    {
        ...
        return view(config('system.paths.dashboard.base') . 'logs.filter', compact('tables', 'roles'));
    }
    ...
    public function show($id)
    {
        ...
        return view(config('system.paths.dashboard.base') . 'logs.show', compact('log'));
    }
