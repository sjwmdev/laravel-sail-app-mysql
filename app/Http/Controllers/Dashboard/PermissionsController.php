...
class PermissionsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view(config('system.paths.dashboard.base') . 'permissions.index', [
    ...
    {
        $routeNames = PermissionsController::getRoutes();
        return view(config('system.paths.dashboard.base') . 'permissions.create', compact('routeNames'));
    }
    ...
    {
        return view(config('system.paths.dashboard.base') . 'permissions.edit', [
